...
{
    public class VSauceConfig : SectionConfigBase<YouTubeDataConfig, YouTubeSchema>
    {
        ...
        public override NavigationInfo ListNavigationInfo
        {
            get 
            {
                return NavigationInfo.FromPage("VSauceListPage");
            }
        }
        ...
        public override ListPageConfig<YouTubeSchema> ListPage
        {
            get 
            {
                return new ListPageConfig<YouTubeSchema>
                {
                    ...
                    NavigationInfo = (item) =>
                    {
                        return NavigationInfo.FromPage("VSauceDetailPage", true);
                    }
                };
            }
        }
