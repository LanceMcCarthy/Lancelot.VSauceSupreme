...
{
    public class WeirdosOfTheMonthConfig : SectionConfigBase<YouTubeDataConfig, YouTubeSchema>
    {
        ...
        public override NavigationInfo ListNavigationInfo
        {
            get 
            {
                return NavigationInfo.FromPage("WeirdosOfTheMonthListPage");
            }
        }
        ...
        public override ListPageConfig<YouTubeSchema> ListPage
        {
            get 
            {
                return new ListPageConfig<YouTubeSchema>
                {
                    ...
                    NavigationInfo = (item) =>
                    {
                        return NavigationInfo.FromPage("WeirdosOfTheMonthDetailPage", true);
                    }
                };
            }
        }
        ...
        {
            get { return "Weirdos of the Month"; }
        }
