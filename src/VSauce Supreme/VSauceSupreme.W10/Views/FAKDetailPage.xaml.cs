...
{
    public sealed partial class FAKDetailPage : PageBase
    {
        private DataTransferManager _dataTransferManager;

        public FAKDetailPage()
        {
            this.ViewModel = new DetailViewModel<YouTubeDataConfig, YouTubeSchema>(new FAKConfig());            
