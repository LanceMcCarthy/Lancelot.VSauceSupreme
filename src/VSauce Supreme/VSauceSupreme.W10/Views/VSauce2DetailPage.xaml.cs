...
{
    public sealed partial class VSauce2DetailPage : PageBase
    {
        private DataTransferManager _dataTransferManager;

        public VSauce2DetailPage()
        {
            this.ViewModel = new DetailViewModel<YouTubeDataConfig, YouTubeSchema>(new VSauce2Config());            
