...
{
    public sealed partial class WeSauceDetailPage : PageBase
    {
        private DataTransferManager _dataTransferManager;

        public WeSauceDetailPage()
        {
            this.ViewModel = new DetailViewModel<YouTubeDataConfig, YouTubeSchema>(new WeSauceConfig());            
