...
{
    public sealed partial class VSauceDetailPage : PageBase
    {
        private DataTransferManager _dataTransferManager;

        public VSauceDetailPage()
        {
            this.ViewModel = new DetailViewModel<YouTubeDataConfig, YouTubeSchema>(new VSauceConfig());            
