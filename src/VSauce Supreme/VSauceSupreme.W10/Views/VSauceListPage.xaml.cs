...
{
    public sealed partial class VSauceListPage : PageBase
    {
        public VSauceListPage()
        {
            this.ViewModel = new ListViewModel<YouTubeDataConfig, YouTubeSchema>(new VSauceConfig());
