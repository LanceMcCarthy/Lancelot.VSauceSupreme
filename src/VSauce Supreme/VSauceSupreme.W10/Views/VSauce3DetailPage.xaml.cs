...
{
    public sealed partial class VSauce3DetailPage : PageBase
    {
        private DataTransferManager _dataTransferManager;

        public VSauce3DetailPage()
        {
            this.ViewModel = new DetailViewModel<YouTubeDataConfig, YouTubeSchema>(new VSauce3Config());            
