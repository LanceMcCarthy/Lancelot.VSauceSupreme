...
{
    public sealed partial class MindBlowDetailPage : PageBase
    {
        private DataTransferManager _dataTransferManager;

        public MindBlowDetailPage()
        {
            this.ViewModel = new DetailViewModel<YouTubeDataConfig, YouTubeSchema>(new MindBlowConfig());            
