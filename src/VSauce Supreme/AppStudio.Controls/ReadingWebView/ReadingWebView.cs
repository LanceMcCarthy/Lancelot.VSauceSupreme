...
namespace AppStudio.Controls
{
    public class ReadingWebView : UserControl
    {
        ...
        private WebView InitializeWebView()
        {
            ...
            webView.DOMContentLoaded += WebViewContentLoaded;
        ...
        private void WebViewContentLoaded(WebView sender, WebViewDOMContentLoadedEventArgs e)
        {
            sender.NavigationStarting += NavigationStarting;
        }
